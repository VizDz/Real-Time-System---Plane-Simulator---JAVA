...
//        System.out.println("TIME SENSOR ALTITUDE DETECT -> " + reportS1);
//        System.out.println("TIME SENSOR CABIN PRESSURE DETECT -> " + reportS2);
//        System.out.println("TIME SENSOR SPEED DETECT -> " + reportS3);
//        System.out.println("TIME SENSOR WEATHER DETECT -> " + reportS4);
//        System.out.println("----- ----- ----- ----- -----");
//        System.out.println("TIME FLIGHT CONTROL GET & SEND ALTITUDE-> " + reportF1);
//        System.out.println("TIME FLIGHT CONTROL GET & SEND CABIN PRESSURE -> " + reportF2);
//        System.out.println("TIME FLIGHT CONTROL GET & SEND SPEED  -> " + reportF3);
//        System.out.println("TIME FLIGHT CONTROL GET & SEND WEATHER CONDITION -> " + reportF4);
//        System.out.println("----- ----- ----- ----- -----");
//        System.out.println("TIME ACTUATOR RECEIVE ALTITUDE FROM FC -> " + reportS1);
//        System.out.println("TIME ACTUATOR RECEIVE CABIN PRESSURE FROM FC -> " + reportS2);
//        System.out.println("TIME ACTUATOR RECEIVE SPEED FROM FC -> " + reportS3);
//        System.out.println("TIME ACTUATOR RECEIVE WEATHER FROM FC -> " + reportS4);
//        System.out.println("----- ----- ----- ----- -----");
