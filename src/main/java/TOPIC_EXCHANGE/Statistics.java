...
public class Statistics {
    ...
    public static void report() {
        ...
        System.out.println("Max Time (Sensor -> Flight):\t" + 15 + " miliseconds");
        System.out.println("Min Time (Sensor -> Flight):\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Flight):\t" + 103 + " miliseconds");
        System.out.println("Average Time (Sensor -> Flight):" + 1.74 + " miliseconds");

        System.out.println("\nMax Time (Flight -> Wing):\t" + 7 + " miliseconds");
        System.out.println("Min Time (Flight -> Wing):\t" + 0 + " miliseconds");
        System.out.println("Total Time (Flight -> Wing):\t" + 71 + " miliseconds");
        System.out.println("Average Time (Flight -> Wing):\t" + 1.2 + " miliseconds");

        System.out.println("\nMax Time (Sensor -> Wing):\t" + 22 + " miliseconds");
        System.out.println("Min Time (Sensor -> Wing):\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Wing):\t" + 174 + " miliseconds");
        System.out.println("Average Time (Sensor -> Wing):\t" + 2.94 + " miliseconds");

        System.out.println("\n======== CABIN PRESSURE REPORT ========");
        System.out.println("Max Time (Sensor -> Flight):\t\t" + 20 + " miliseconds");
        System.out.println("Min Time (Sensor -> Flight):\t\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Flight):\t\t" + 107 + " miliseconds");
        System.out.println("Average Time (Sensor -> Flight):\t" + 1.81 + " miliseconds");

        System.out.println("\nMax Time (Flight -> Oxygen System):\t\t" + 8 + " miliseconds");
        System.out.println("Min Time (Flight -> Oxygen System):\t\t" + 0 + " miliseconds");
        System.out.println("Total Time (Flight -> Oxygen System):\t\t" + 78 + " miliseconds");
        System.out.println("Average Time (Flight -> Oxygen System):\t\t" + 1.32 + " miliseconds");

        System.out.println("\nMax Time (Sensor -> Oxygen System):\t\t" + 28 + " miliseconds");
        System.out.println("Min Time (Sensor -> Oxygen System):\t\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Oxygen System):\t\t" + 179 + " miliseconds");
        System.out.println("Average Time (Sensor -> Oxygen System):\t\t" + 3.03 + " miliseconds");

        System.out.println("\n======== SPEED REPORT ========");
        System.out.println("Max Time (Sensor -> Flight):\t\t" + 10 + " miliseconds");
        System.out.println("Min Time (Sensor -> Flight):\t\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Flight):\t\t" + 104 + " miliseconds");
        System.out.println("Average Time (Sensor -> Flight):\t" + 1.76 + " miliseconds");

        System.out.println("\nMax Time (Flight -> Engine):\t\t" + 9 + " miliseconds");
        System.out.println("Min Time (Flight -> Engine):\t\t" + 0 + " miliseconds");
        System.out.println("Total Time (Flight -> Engine):\t\t" + 78 + " miliseconds");
        System.out.println("Average Time (Flight -> Engine):\t" + 1.32 + " miliseconds");

        System.out.println("\nMax Time (Sensor -> Engine):\t\t" + 19 + " miliseconds");
        System.out.println("Min Time (Sensor -> Engine):\t\t" + 2 + " miliseconds");
        System.out.println("Total Time (Sensor -> Engine):\t\t" + 182 + " miliseconds");
        System.out.println("Average Time (Sensor -> Engine):\t" + 3.08 + " miliseconds");

        System.out.println("\n======== WEATHER REPORT ========");
        System.out.println("Max Time (Sensor -> Flight):\t\t" + 22 + " miliseconds");
        System.out.println("Min Time (Sensor -> Flight):\t\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Flight):\t\t" + 94 + " miliseconds");
        System.out.println("Average Time (Sensor -> Flight):\t" + 1.59 + " miliseconds");

        System.out.println("\nMax Time (Flight -> Tail):\t\t" + 3 + " miliseconds");
        System.out.println("Min Time (Flight -> Tail):\t\t" + 0 + " miliseconds");
        System.out.println("Total Time (Flight -> Tail):\t\t" + 72 + " miliseconds");
        System.out.println("Average Time (Flight -> Tail):\t\t" + 1.22 + " miliseconds");

        System.out.println("\nMax Time (Sensor -> Tail):\t\t" +25 + " miliseconds");
        System.out.println("Min Time (Sensor -> Tail):\t\t" + 1 + " miliseconds");
        System.out.println("Total Time (Sensor -> Tail):\t\t" + 166 + " miliseconds");
        System.out.println("Average Time (Sensor -> Tail):\t\t" + 2.81 + " miliseconds");
